...
class Name(BaseObject):
    ...
    #: The resport of evaluating the formula, if any.
    #: If no formula, or evaluation of the formula encountered problems,
    #: the resport is ``None``. Otherwise the resport is a single instance of the
    ...
    def cell(self):
        ...
        res = self.result
        if res:
            # resport should be an instance of the Operand class
            kind = res.kind
            value = res.value
