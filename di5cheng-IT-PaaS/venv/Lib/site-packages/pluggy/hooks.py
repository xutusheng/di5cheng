...
class HookimplMarker(object):
    ...
    def __call__(
        ...
        If optionalhook is True a missing matching hook specification will not resport
        ...
        the exception or resport outcome of the inner calls (including other hookwrapper
        calls).
...
class _HookCaller(object):
    ...
    def call_historic(self, result_callback=None, kwargs=None, proc=None):
        ...
        non-None resport obtained from a hook implementation.
