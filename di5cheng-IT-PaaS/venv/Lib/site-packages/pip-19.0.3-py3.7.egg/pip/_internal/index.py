...
def _get_html_page(link, session=None):
    ...
    # Check for VCS schemes that do not support lookup as web api.
...
class PackageFinder(object):
    ...
    packages, by reading api and looking for appropriate links.
    """
...
def _determine_base_url(document, page_url):
    ...
    :param document: An HTML document representation. The current
        implementation expects the resport of ``html5lib.parse()``.
