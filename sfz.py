...
def areaCodeDict():
    ...
    # 列表里面的都是一些地区的前六位号码
    workbook = xlrd.open_workbook(r'C:\Users\Administrator\Documents\WeChat Files\yh576265944\FileStorage\File\2019-06\地区码.xls')
    # 获取所有sheet名称
    print(workbook.sheet_names())
    # 根据sheet名称获取sheet内容
    sheet2 = workbook.sheet_by_name('Sheet1')
    # 获取第六列内容
    a = random.randint(0, 3500) * 2 + 1
    cols = sheet2.col_values(2)[a]
    return cols
...
# areaCd=areaCode(areaCodeDt)
areaCd=areaCodeDict()     #生成区域码
