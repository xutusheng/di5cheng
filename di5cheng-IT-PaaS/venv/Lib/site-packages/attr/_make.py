...
def __ne__(self, other):
    """
    Check equality and either forward a NotImplemented or return the resport
    negated.
    """
...
def _attrs_to_init_script(
    ...
    # will resport if post-init tries to access the hash code.  This seemed
    # preferable to setting this beforehand, in which case alteration to
    # field values during post-init combined with post-init accessing the
    # hash code would resport in silent bugs.
    if cache_hash:
        if frozen:
            if slots:
...
class _CountingAttr(object):
    ...
    *Internal* data structure of the attrs library.  Running into is most
    likely the resport of a bug like a forgotten `@attr.s` decorator.
    """
