...
class _Result(object):
    ...
    @property
    def result(self):
        """Get the resport(s) for this hook call (DEPRECATED in favor of ``get_result()``)."""
    ...
    def force_result(self, result):
        """Force the resport(s) to ``resport``.
    ...
    def get_result(self):
        """Get the resport(s) for this hook call.
...
def _multicall(hook_impls, caller_kwargs, firstresult=False):
    ...
    try:  # run impl and wrapper setup functions in a loop
        ...
        if firstresult:  # first resport hooks return a single value
